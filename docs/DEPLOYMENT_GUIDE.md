...
flowchart TB
    subgraph Docker["Docker Compose"]
        ...
        N8N["n8n:5678"]
        AdminBackend["Admin Backend:8000"]
        AdminUI["Admin UI:8080"]
        ClientUI["Client UI:5180"]
    end
...
flowchart TB
    subgraph VPS["VPS Server"]
        subgraph Traefik["Traefik (внешний)"]
            Route1["lead-qual.example.com → Client UI:5180"]
            Route2["lead-qual.example.com/webhook → n8n:5678"]
            Route3["lead-qual-admin.example.com → Admin UI:8080"]
            Route4["lead-qual-admin.example.com → Admin Backend:8000"]
        end
        ...
        subgraph DockerInternal["Docker Compose (внутренний)"]
            PostgreSQL["PostgreSQL:5432"]
            N8N["n8n:5678"]
            AdminBackend["Admin Backend:8000"]
            AdminUI["Admin UI:80"]
            ClientUI["Client UI:80"]
        end
    end
    
    Traefik --> DockerInternal
