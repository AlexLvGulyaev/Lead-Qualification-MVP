...
**Дата:** 2026-09-15
**Статус:** Инженерный reference логики классификатора: категории, приоритеты, confidence, промпт, fallback, SLA.
...
## ⏱️ 8. SLA (Service Level Agreement)
