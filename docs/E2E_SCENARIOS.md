...
**Дата:** 2026-09-15
**Статус:** Три сквозных сценария на реальных демо-обращениях: Warm (Website), Hot (Telegram), Spam (Website).
...
![Kommo: Warm Deal](screenshots/kommo-deal-warm.png)
...
- Номер обращения LQ-100031 для коммуникации
...
Бот подтверждает приём и регистрирует обращение с номером LQ-100032.
...
Система принимает и регистрирует обращение с номером LQ-100037.
...
![Kommo: Spam Deal](screenshots/kommo-deal-spam.png)
...
|----------|----------|-----------------|---------------|------------------|
| Warm Lead | Website | LQ-100031 | Заинтересованный клиент | +24 часа |
| Hot Lead | Telegram | LQ-100032 | Готов к внедрению | +15 минут |
| Spam | Website | LQ-100037 | Нецелевое обращение | Не создаётся |

---

## 🎯 5. Что показывает документ
