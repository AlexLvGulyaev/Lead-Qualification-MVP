...
**Дата:** 2026-09-15
**Статус:** Продуктовый документ: какие проблемы бизнеса решает система и что получает бизнес после внедрения.

Документ объясняет, какую бизнес-ценность приносит Lead Qualification MVP и какие проблемы решает.

---

## 💡 1. Что такое Lead Qualification MVP
...
## 🧩 2. Какие проблемы бизнеса решает система
...
## ⚙️ 4. Ключевые возможности системы
...
## ⚖️ 6. Почему Lead Qualification MVP отличается от ручной обработки
